    ...
    <div>
      ...
      <div className="flex flex-col justify-start items-start text-justify mb-5">
        ...
        <div className="w-full flex flex-col items-start gap-4 my-6">
          <h1 className="text-2xl font-bold">Cookieの使用について</h1>
          <div>
        ...
        <div className="w-full flex flex-col items-start gap-4 my-6">
          <h1 className="text-2xl font-bold">アクセス解析サービスについて</h1>
          <div>
        ...
        <div className="w-full flex flex-col items-start gap-4 my-6">
          <h1 className="text-2xl font-bold">免責事項について</h1>
          <div>
        ...
        <div className="w-full flex flex-col items-start gap-4 my-6">
          <h1 className="text-2xl font-bold">著作権</h1>
          <div>
        ...
        <div className="w-full flex flex-col items-start gap-4 my-6">
          <h1 className="text-2xl font-bold">プライバシーポリシーの変更</h1>
          <div>
